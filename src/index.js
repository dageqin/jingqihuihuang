...
function createMap() {
    ...
    var point = new BMap.Point(116.597458, 39.919263);//定义一个中心点坐标
...
var $phone = $("#phone");
var $contactWechat = $('#contactWechat');
var $wechat = $("#wechat");
$contactPhone.bind('mouseenter', function(){
    $phone.css('display', 'block');
});
$contactPhone.bind('mouseleave', function(){
    $phone.css('display', 'none');
});
$contactWechat.bind('mouseenter', function(){
    $wechat.css('display', 'block');
});
$contactWechat.bind('mouseleave', function(){
